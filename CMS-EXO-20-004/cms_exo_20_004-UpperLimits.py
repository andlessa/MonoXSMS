...
def computeULs(inputFile,outputFile,deltas=0.0):
    ...
    # ### Load CMS data
    cmsYieldFile = './AuxInfo/CMS-EXO-20-004-data/HEPData-ins1894408-v2-csv/Simplifiedlikelihood_Yields(Monojet).csv'
    ...
    covarianceFile = './AuxInfo/CMS-EXO-20-004-data/HEPData-ins1894408-v2-csv/Simplifiedlikelihood_covariancematrix(Monojet).csv'
